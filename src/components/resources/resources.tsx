...
export default function Resources() {
  ...
  return (
    <div className="container-page py-16">
      ...
      <div className="mb-8 flex flex-wrap gap-2">
        {FILTERS.map((filter) => (
          <button
            ...
            className={
              active === filter.key
                ? 'rounded-full bg-ink px-4 py-1.5 text-sm font-medium text-white shadow-sm transition-all hover:-translate-y-px'
                : 'rounded-full border border-black/10 bg-white px-4 py-1.5 text-sm font-medium text-ink/60 transition-all hover:border-aurora-500/40 hover:text-ink'
            }
          >
            {filter.label}
          </button>
          ...
          {filtered.map((resource, i) => {
            ...
            return (
              <a
                ...
                className="group flex flex-col rounded-2xl border border-black/5 bg-white p-5 shadow-card transition-all hover:-translate-y-0.5 hover:border-aurora-400/40 hover:shadow-card-hover"
              >
      ...
      <div className="mt-10 flex flex-col items-start gap-3 rounded-2xl border border-sunrise-200 bg-gradient-to-br from-sunrise-50 to-aurora-50 p-6 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-ink/60">
            ...
            <code className="rounded bg-white/80 px-1.5 py-0.5 text-xs text-sunrise-800">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="shrink-0 rounded-xl bg-ink px-5 py-3 text-sm font-medium text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
        >
