    ...
    <div className="container-page py-16">
      <header className="mb-10 max-w-2xl">
        ...
        <p className="mt-3 text-lg text-ink/60">
          Internships, hackathons, jobs and research openings shared by the community. Newest first.
        </p>
      </header>
        ...
        <div className="flex flex-col gap-4">
          {list.map((opp, i) => (
            <a
              ...
              className="group flex flex-col gap-3 rounded-2xl border border-line/10 bg-surface-2 p-6 shadow-card transition-all hover:-translate-y-0.5 hover:border-aurora-400/40 hover:shadow-card-hover md:flex-row md:items-center"
            >
              <div className="flex-1">
                ...
                <h2 className="mt-3 font-display text-xl font-semibold text-ink transition-colors group-hover:text-aurora-700">
                  {opp.title}
                </h2>
